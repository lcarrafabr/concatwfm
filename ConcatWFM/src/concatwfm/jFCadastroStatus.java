 ...
 */
public class jFCadastroStatus extends javax.swing.JDialog {

    /**
     * Creates new form jFCadastroStatus
     */
    public jFCadastroStatus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        statusNamejTextField = new javax.swing.JTextField();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        gradeStatusjTable = new javax.swing.JTable();
        ...
        jLabel1.setText("Nome do status");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(statusNamejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 326, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(statusNamejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(16, Short.MAX_VALUE))
        );

        jTabbedPane1.addTab("Cadastro de Status", jPanel1);

        jPanel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        gradeStatusjTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        gradeStatusjTable.getTableHeader().setReorderingAllowed(false);
        gradeStatusjTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gradeStatusjTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(gradeStatusjTable);
        gradeStatusjTable.getColumnModel().getColumn(0).setResizable(false);
        gradeStatusjTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeStatusjTable.getColumnModel().getColumn(1).setResizable(false);
        gradeStatusjTable.getColumnModel().getColumn(1).setPreferredWidth(190);
    ...
    public void getGrandeStatus() throws ParseException {
        //Consultar pedidos
...
//        }
        ...
        String[] colunasTabela = new String[]{"Id#", "Nome status"};
        ...
        gradeStatusjTable.setModel(modeloTabela);
        gradeStatusjTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeStatusjTable.getColumnModel().getColumn(1).setPreferredWidth(190);
        ...
        try {
            ...
            resultSet = oCadStatus.getConsultar();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                modeloTabela.addRow(new String[]{
                            Funcoes.getCodigoFormat(resultSet.getInt("STATUSID")),
    ...
    public void getFieldStatus(int click_status) throws ParseException {

        CadastroStatus oCadStatus = new CadastroStatus();
        ResultSet rs;
        oCadStatus.setStatus_id(click_status);
        ...
        try {
            ...
            //Pegar campos
            statusNamejTextField.setText(rs.getString("STATUS_NAME"));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao abrir coneção com o banco de dados.\n"+e,
    ...
    private void novojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_novojButtonActionPerformed
        ...
        statusNamejTextField.grabFocus();
    ...
    private void limparjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_limparjButtonActionPerformed
        // TODO add your handling code here:
        statusNamejTextField.setText("");
    }//GEN-LAST:event_limparjButtonActionPerformed

    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        // TODO add your handling code here:
        if(statusNamejTextField.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "O campo NOME DO STATUS é obrigatório.", "Mensagem do sistema", JOptionPane.WARNING_MESSAGE);
            statusNamejTextField.grabFocus();
            ...
            try {
                ...
                oCadStatus.setNome_status(statusNamejTextField.getText().trim().toUpperCase());
                oCadStatus.setCadastrar();                
    ...
    private void buscarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarjButtonActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao carregar grade status.\n"+e,
                        "Mensagem do sistema", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void gradeStatusjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gradeStatusjTableMouseClicked
        // TODO add your handling code here:
        editarjButton.setVisible(true);

        click_status = Integer.parseInt(gradeStatusjTable.getValueAt(gradeStatusjTable.getSelectedRow(), 0).toString());
        try {
            getFieldStatus(click_status);
        } catch (ParseException ex) {
            Logger.getLogger(CadastroStatus.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_gradeStatusjTableMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFCadastroStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new jFCadastroStatus().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable gradeStatusjTable;
    ...
    private javax.swing.JTextField statusNamejTextField;
