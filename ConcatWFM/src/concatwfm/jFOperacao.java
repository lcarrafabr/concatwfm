...
public class jFOperacao extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        nomeOperacaojTextField = new javax.swing.JTextField();
        idOperacaojTextField = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        jPanel2 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        gradeOperacaojTable = new javax.swing.JTable();
        ...
        jLabel1.setText("Nome da Operação");

        idOperacaojTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                idOperacaojTextFieldKeyTyped(evt);
            }
        });

        jLabel2.setText("Id# op.");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(idOperacaojTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nomeOperacaojTextField)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nomeOperacaojTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(idOperacaojTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(18, Short.MAX_VALUE))
        );

        jTabbedPane1.addTab("Cadastro operações", jPanel1);

        jPanel2.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        gradeOperacaojTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        gradeOperacaojTable.getTableHeader().setReorderingAllowed(false);
        gradeOperacaojTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gradeOperacaojTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(gradeOperacaojTable);
        gradeOperacaojTable.getColumnModel().getColumn(0).setResizable(false);
        gradeOperacaojTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeOperacaojTable.getColumnModel().getColumn(1).setResizable(false);
        gradeOperacaojTable.getColumnModel().getColumn(1).setPreferredWidth(250);
    ...
    int verifica_id;
    int click_cod_operacao;
    
    public void getGrandeOperacoes() throws ParseException {
        //Consultar operacoes
        Operacoes oPer = new Operacoes();

        ResultSet resultSet = null;

        String[] colunasTabela = new String[]{"Id#", "Nome operação"};
        ...
        gradeOperacaojTable.setModel(modeloTabela);
        gradeOperacaojTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        gradeOperacaojTable.getColumnModel().getColumn(1).setPreferredWidth(250);

        try {

            resultSet = oPer.getConsultarIdOperacao();
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                modeloTabela.addRow(new String[]{
                            resultSet.getString("OPERACAO_ID"),
    ...
    public void getFieldOperacoes(int click_cod_operacao) throws ParseException {

        Operacoes oOper = new Operacoes();
        ResultSet rs;
        oOper.setOperacao_id(click_cod_operacao);

        try {
            rs = oOper.getConsultarIdOperacao();
            rs.next();

            //Pegar campos
            idOperacaojTextField.setText(Integer.toString(rs.getInt("OPERACAO_ID")));
            nomeOperacaojTextField.setText(rs.getString("OPERACAO_NAME"));
    ...
    private void consultaIdOperacao() {
        ...
        try {
            oOper.setOperacao_id(Integer.parseInt(idOperacaojTextField.getText().trim()));
            
            rs = oOper.getConsultarIdOperacao();
            while (rs.next()) {              
                verifica_id = rs.getInt("OPERACAO_ID");   
            }
        } catch (NumberFormatException | SQLException e) {
            JOptionPane.showMessageDialog(null, "Erro ao verificar ID da operação no banco de dados.\n" + e,
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        idOperacaojTextField.grabFocus();
    ...
    private void limparjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_limparjButtonActionPerformed
        // TODO add your handling code here:
        nomeOperacaojTextField.setText("");
    ...
    private void salvarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarjButtonActionPerformed
        ...
        if (nomeOperacaojTextField.getText().isEmpty() || idOperacaojTextField.getText().isEmpty()) {
            
            JOptionPane.showMessageDialog(null, "Atenção!\nTodos os campos são obrigatórios.", "Mensagem do sistema", JOptionPane.WARNING_MESSAGE);
            
        } else if (verifica_id == Integer.parseInt(idOperacaojTextField.getText().trim())) {
            
            JOptionPane.showMessageDialog(null, "Atenção!\nO Id " + verifica_id + " já existe.\n"
                    + "Por favor, cadastre outro numero.", "Mensagem do sistema.", JOptionPane.WARNING_MESSAGE);
            ...
            try {
                ...
                oPeracao.setOperacao_id(Integer.parseInt(idOperacaojTextField.getText().trim()));
                oPeracao.setOperacao_name(nomeOperacaojTextField.getText().trim().toUpperCase());
                oPeracao.setCadastrar();
    ...
    private void idOperacaojTextFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_idOperacaojTextFieldKeyTyped
        // TODO add your handling code here:
        String caracteres = "0987654321";
        if (!caracteres.contains(evt.getKeyChar() + "")) {
            evt.consume();
        }
    }//GEN-LAST:event_idOperacaojTextFieldKeyTyped
    ...
    private void buscarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarjButtonActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao carregar grade\n"+e, 
                    "Mensagem do sistena", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_buscarjButtonActionPerformed

    private void gradeOperacaojTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gradeOperacaojTableMouseClicked
        // TODO add your handling code here:
        editarjButton.setVisible(true);

        click_cod_operacao = Integer.parseInt(gradeOperacaojTable.getValueAt(gradeOperacaojTable.getSelectedRow(), 0).toString());
        try {
            getFieldOperacoes(click_cod_operacao);
        } catch (ParseException ex) {
            Logger.getLogger(Operacoes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_gradeOperacaojTableMouseClicked
    ...
    private void alterarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarjButtonActionPerformed
        ...
        if (nomeOperacaojTextField.getText().isEmpty() || idOperacaojTextField.getText().isEmpty()) {
            ...
            try {
                ...
                oPeracao.setCod_operacao_id(click_cod_operacao);
                
                oPeracao.setOperacao_id(Integer.parseInt(idOperacaojTextField.getText().trim()));
                oPeracao.setOperacao_name(nomeOperacaojTextField.getText().trim().toUpperCase());
                oPeracao.setAlterar(conecta);
    ...
    private javax.swing.JTable gradeOperacaojTable;
    private javax.swing.JTextField idOperacaojTextField;
    ...
    private javax.swing.JTextField nomeOperacaojTextField;
