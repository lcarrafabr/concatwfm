...
public class Funcoes {
    ...
    public static void deletaArquivoNoDiretorio(String caminho, String nome_do_arquivo) {

        File deletaArquivo = new File(caminho + nome_do_arquivo);
        deletaArquivo.delete();
